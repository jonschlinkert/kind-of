...
kindOf.async = function async(value) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(accel) {
      switch (accel.label) {
        case 0: return [4, kindOf(value)];
        case 1: return [2, accel.sent()];
      }
    });
  });
};
...
/**
 *  Promise polyfills (async function), compatible with ES3 and ES5
 */
