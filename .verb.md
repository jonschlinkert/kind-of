...
**Iterators**
```typescript
// For Array, String, and Set iterators the return type will be "stringiterator" | "setiterator" | "arrayiterator"
kindOf(""[Symbol.iterator]());
```

**Object.create(...)**
```typescript
// You will need to type Object.create(...) yourself as TypeScript types this as any/undefined
